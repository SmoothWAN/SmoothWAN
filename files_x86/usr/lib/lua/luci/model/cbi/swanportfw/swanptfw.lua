...
s = m:section(TypedSection, "redirect", "Speedify Dedicated Port Forwarding", "Applies to Speedify dedicated plan only. (Forwards UDP and TCP)<br>Add the same source and destination ports in Speedify afterwards.")
